...
(build~p), \texttt{ai\_scenarios\_buildp\_published.json} (build~p as first
published, with Head Start and Early Head Start in net income) and
\texttt{ai\_scenarios\_buildo.json} (build~o) are committed; the last two are
the stability comparison of Section~\ref{sec:stability}, so every value and
